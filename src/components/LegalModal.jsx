...
const TERMS_CONTENT = (
  <div className="space-y-6 text-sm text-gray-700 leading-relaxed font-medium">
    ...
    <p>Welcome to <strong className="text-gray-900">ICELL GADGETS!</strong> These Terms and Conditions ("Terms") govern your use of our website at <strong>https://www.icellgadgets.ng</strong> and the purchase of any electronics or products from us. By accessing the Site or purchasing a product, you agree to be bound by these Terms.</p>
    ...
    {[
      ...
      },
      {
        ...
        body: 'We strive to be as accurate as possible with product descriptions, technical specifications, and images. However, ICELL GADGETS does not warrant that product descriptions are 100% accurate. In the event of a pricing error, ICELL GADGETS reserves the right to refuse or cancel orders, and if payment has been processed, a full refund will be issued.'
      },
      {
        n: '3', title: 'Payments and Billing',
        body: 'All payments are securely processed through Klump BNPL or verified via direct bank transfer. We accept installment payments and direct account transfers. By submitting an order, you authorize ICELL GADGETS to process your designated payment method for the full order amount.'
      },
      {
        n: '4', title: 'Shipping, Delivery, and Risk of Loss',
        body: 'Delivery dates given at checkout are estimates only and cannot be guaranteed. ICELL GADGETS is not liable for delays caused by local dispatch services or factors beyond our control. Risk of loss and title for items pass to you upon our delivery to the courier/logistics partner.'
      },
    ].map(s => (
      <div key={s.n}>
    ...
    <div className="border-2 border-red-400 rounded-sm overflow-hidden">
      ...
      <div className="p-4 bg-red-50 space-y-2">
        <p className="font-bold text-red-800"><strong>Final Sale:</strong> All sales on ICELL GADGETS are final. We enforce a strict No-Return and No-Refund policy once an item has been purchased and successfully dispatched or delivered.</p>
        ...
        <p className="text-red-700"><strong>Manufacturer Warranties:</strong> ICELL GADGETS itself does not provide additional store warranties. For any technical faults discovered after delivery, your sole remedy is to contact the manufacturer's authorized service center in Nigeria.</p>
      </div>
    </div>
    ...
    {[
      {
        ...
        body: 'All content on this Site — including text, graphics, logos, images, and software — is the property of ICELL GADGETS or its content suppliers and is protected by Nigerian and international copyright, trademark, and intellectual property laws.'
      },
      {
        n: '7', title: 'Limitation of Liability',
        body: 'To the maximum extent permitted by applicable Nigerian law, ICELL GADGETS shall not be liable for any indirect, incidental, special, consequential, or punitive damages including loss of profits, data, product failure, electrical surges, battery degradation, or personal injury resulting from the use or misuse of electronics purchased through the Site. Our total liability shall not exceed the amount you paid for the specific product in question.'
      },
      {
      ...
      },
      {
        ...
        body: 'ICELL GADGETS reserves the right to update or modify these Terms at any time without prior notice. Your continued use of the Site following any changes constitutes your acceptance of the new Terms.'
      },
    ].map(s => (
      <div key={s.n}>
        <h3 className="font-black text-gray-900 uppercase tracking-wider text-xs mb-2 flex items-center gap-2">
...
const PRIVACY_CONTENT = (
  <div className="space-y-6 text-sm text-gray-700 leading-relaxed font-medium">
    <p>ICELL GADGETS ("we", "our", "us") is committed to protecting your personal information and your right to privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information. This policy is aligned with the <strong className="text-gray-900">Nigeria Data Protection Regulation (NDPR)</strong> issued by NITDA.</p>
