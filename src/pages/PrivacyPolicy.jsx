      ...
      <div className="flex-grow max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
        ...
        <div className="bg-white border border-gray-200 rounded-sm p-6 mb-6 shadow-sm">
          <p className="text-sm text-gray-700 leading-relaxed font-medium">
            ICELL GADGETS ("we", "our", "us") is committed to protecting your personal information and your right to privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website{' '}
