      ...
      <div className="flex-grow max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
        ...
        <div className="bg-white border border-gray-200 rounded-sm p-6 mb-6 shadow-sm">
          <p className="text-sm text-gray-700 leading-relaxed font-medium">
            Welcome to <strong className="text-gray-900">ICELL GADGETS!</strong> These Terms and Conditions ("Terms") govern your use of our website located at{' '}
            <a href="https://www.icellgadgets.ng" className="text-lime-600 hover:underline font-bold">https://www.icellgadgets.ng</a>{' '}
        ...
        <div className="space-y-4">
          {[
            ...
            },
            {
              ...
              content: (
                <>
                  ...
                  <p><strong className="text-gray-900">Authorization:</strong> By submitting an order, you authorize ICELL GADGETS (via Klump or direct transfer verification) to process the total amount of your order, including applicable taxes (such as VAT) and delivery fees.</p>
                </>
              )
            },
            {
              ...
              content: (
                <>
                  <p className="mb-3"><strong className="text-gray-900">Shipping Estimates:</strong> Delivery dates given at checkout are estimates only and cannot be guaranteed. ICELL GADGETS is not liable for delays caused by local dispatch services, interstate logistics tracking issues, or factors beyond our control.</p>
                  <p><strong className="text-gray-900">Risk of Loss:</strong> All physical items purchased from ICELL GADGETS are made pursuant to a shipment contract. The risk of loss and title for such items pass to you upon our delivery to the courier/logistics partner.</p>
                </>
              )
            },
            {
              ...
              content: (
                <>
                  <div className="bg-red-50 border border-red-200 rounded-sm p-4 mb-4">
                    <p className="text-red-800 font-bold text-sm"><i className="fas fa-exclamation-circle mr-2"></i>All sales on ICELL GADGETS are final. We enforce a strict No-Return and No-Refund policy once an item has been purchased and successfully dispatched or delivered.</p>
                  </div>
                  ...
                  <p><strong className="text-gray-900">Manufacturer Warranties:</strong> Many electronics sold on ICELL GADGETS come with an official manufacturer's warranty. ICELL GADGETS itself does not provide additional store warranties. For any technical faults or defects discovered after delivery, your sole remedy is to contact the manufacturer's authorized service center in Nigeria under their warranty terms.</p>
                </>
              )
            },
            {
              ...
              content: (
                <p>All content on this Site — including text, graphics, logos, button icons, images, digital downloads, and software — is the property of ICELL GADGETS or its content suppliers and is protected by Nigerian and international copyright, trademark, and intellectual property laws.</p>
              )
            },
            {
              number: '7',
              ...
              content: (
                <>
                  <p className="mb-3">To the maximum extent permitted by applicable Nigerian law, ICELL GADGETS, its directors, employees, or affiliates shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to:</p>
                  ...
                  <p>Our total liability for any claim arising out of these Terms shall not exceed the amount you paid to ICELL GADGETS for the specific product in question.</p>
                </>
              )
            },
            {
            ...
            },
            {
              ...
              content: (
                <p>ICELL GADGETS reserves the right to update or modify these Terms at any time without prior notice. The "Last Updated" date at the top of this page will indicate when changes were made. Your continued use of the Site following any changes constitutes your acceptance of the new Terms.</p>
              )
            },
            {
              number: '11',
